...
MIDDLEWARE_CLASSES = (
    ...
    # This is disabled so we don't set a cookie.
    # We don't need it to protect any forms currently, but should be renabled
    # if we add forms that we don't want others to submit.
