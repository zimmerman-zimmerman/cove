...
COVE_CONFIG = {
    ...
    'schema_version_choices': OrderedDict((  # {version: (display, url)}
        ('1.0', ('1.0', 'http://standard.open-contracting.org/1.0-dev/en/')),
        ('1.1', ('1.1', 'http://standard.open-contracting.org/1.1-dev/en/')),
    )),
    'schema_codelists': OrderedDict((  # {version: codelist_dir}
        ('1.1', 'https://raw.githubusercontent.com/open-contracting/standard/1.1.1-dev/standard/schema/codelists/'),
    )),
