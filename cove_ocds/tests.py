...
def test_get_additional_codelist_values():
    ...
    assert additional_codelist_values == {
        ('releases', 'tag'): {
            ...
            'codelist_url': 'https://raw.githubusercontent.com/open-contracting/standard/1.1.1-dev/standard/schema/codelists/releaseTag.csv',
            'field': 'tag',
            'isopen': False,
            'path': 'releases',
            'values': {'oh no'}
        ...
        ('releases', 'tender', 'items', 'classification', 'scheme'): {
            ...
            'codelist_url': 'https://raw.githubusercontent.com/open-contracting/standard/1.1.1-dev/standard/schema/codelists/itemClassificationScheme.csv',
            'field': 'scheme',
            'isopen': True,
